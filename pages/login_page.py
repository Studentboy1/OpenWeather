...
#guide weather api (раздел Guide)
    def get_click_guide_weather_api_page(self):
        self.get_click_guide_weather_api()

    def get_click_guide_weather_api(self):
        assert MainPageLocators.guide_weather_api.is_displayed(), "The guide weather api page is present"

    def test_current_url_guide_weather_api(self):
        try:
            assert "https://openweathermap.org/api" in self.url == 'https://openweathermap.org/api'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide road risk api (раздел Guide)
    def get_click_guide_road_risk_api_page(self):
        self.get_click_guide_road_risk_api()

    def get_click_guide_road_risk_api(self):
        assert MainPageLocators.guide_road_risk_api.is_displayed(), "The guide road risk api page is present"

    def test_current_url_guide_road_risk_api(self):
        try:
            assert "https://openweathermap.org/api/road-risk" in self.url == 'https://openweathermap.org/api/road-risk'
        except AssertionError:
            print("URL не соответствует ожидаемому")
        else:
            print("URL соответствует ожидаемому")
...
#guide_forecast_four_days
    def get_click_guide_forecast_four_days_page(self):
        self.get_click_guide_forecast_four_days()

    def get_click_guide_forecast_four_days(self):
        assert MainPageLocators.guide_forecast_four_days.is_displayed(), "The guide forecast four days page is present"

    def test_current_url_guide_forecast_four_days(self):
        try:
            assert "https://openweathermap.org/api/hourly-forecast" in self.url == 'https://openweathermap.org/api/hourly-forecast'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide_forecast_thirty_days
    def get_click_guide_forecast_thirty_days_page(self):
        self.get_click_guide_forecast_thirty_days()

    def get_click_guide_forecast_thirty_days(self):
        assert MainPageLocators.guide_forecast_thirty_days.is_displayed(), "The guide forecast thirty days page is present"

    def test_current_url_guide_forecast_thirty_days(self):
        try:
            assert "https://openweathermap.org/api/forecast30" in self.url == 'https://openweathermap.org/api/forecast30'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide_current_learn_more
    def get_click_guide_current_learn_more_page(self):
        self.get_click_guide_current_learn_more()

    def get_click_guide_current_learn_more(self):
        assert MainPageLocators.guide_current_learn_more.is_displayed(), "The guide current learn more page is present"

    def test_current_url_guide_current_learn_more(self):
        try:
            assert "https://openweathermap.org/api#current" in self.url == 'https://openweathermap.org/api#current'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide_statistical_weather_api
    def get_click_guide_statistical_weather_api_page(self):
        self.get_click_guide_statistical_weather_api()

    def get_click_guide_statistical_weather_api(self):
        assert MainPageLocators.guide_statistical_weather_api.is_displayed(), "The guide statistical weather api page is present"

    def test_current_url_guide_statistical_weather_api(self):
        try:
            assert "https://openweathermap.org/api/statistics-api" in self.url == 'https://openweathermap.org/api/statistics-api'
        except AssertionError:
            print("URL не соответствует ожидаемому")
        else:
            print("URL соответствует ожидаемому")

#guide_history_learn_more
    def get_click_guide_history_learn_more_page(self):
        self.get_click_guide_history_learn_more()

    def get_click_guide_history_learn_more(self):
        assert MainPageLocators.guide_statistical_weather_api.is_displayed(), "The guide history learn more page is present"

    def test_current_url_guide_history_learn_more(self):
        try:
            assert "https://openweathermap.org/api#history" in self.url == 'https://openweathermap.org/api#history'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide_weather_map
    def get_click_guide_weather_map_page(self):
        self.get_click_guide_weather_map()

    def get_click_guide_weather_map(self):
        assert MainPageLocators.guide_weather_map.is_displayed(), "The guide weather map page is present"

    def test_current_url_guide_weather_map(self):
        try:
            assert "https://openweathermap.org/api/weather-map-2" in self.url == 'https://openweathermap.org/api/weather-map-2'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide_weather_map_learn_more
    def get_click_guide_weather_map_learn_more_page(self):
        self.guide_weather_map_learn_more()

    def get_click_guide_weather_map_learn_more(self):
        assert MainPageLocators.guide_weather_map_learn_more.is_displayed(), "The guide weather map learn more page is present"

    def test_current_url_guide_weather_map_learn_more(self):
        try:
            assert "https://openweathermap.org/api#maps" in self.url == 'https://openweathermap.org/api#maps'
        except AssertionError:
            print("URL не соответствует ожидаемому")
...
#guide_geocoding_api
    ...
    def get_click_guide_geocoding_api(self):
        assert MainPageLocators.guide_geocoding_api.is_displayed(), "The guide geocoding api page is present"

    def test_current_url_guide_geocoding_api(self):
        try:
