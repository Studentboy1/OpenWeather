...
class MainPage(BasePage):
    ...
    def go_to_guide_current_state(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,700)")
        time.sleep(2)
        click_guide_current_state = self.browser.find_element(*MainPageLocators.guide_current_state)
    ...
    def go_to_guide_forecast_sixteen_days(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,900)")
        time.sleep(2)
        click_guide_forecast_sixteen_days = self.browser.find_element(*MainPageLocators.guide_forecast_sixteen_days)
        click_guide_forecast_sixteen_days.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)

    def go_to_guide_forecast_thirty_days(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,900)")
        time.sleep(2)
        click_guide_forecast_thirty_days = self.browser.find_element(*MainPageLocators.guide_forecast_thirty_days)
        click_guide_forecast_thirty_days.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)

    def go_to_guide_current_learn_more(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1000)")
        time.sleep(2)
        click_guide_current_learn_more = self.browser.find_element(*MainPageLocators.guide_current_learn_more)
        click_guide_current_learn_more.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)
    ...
    def go_to_guide_history_api(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1000)")
        time.sleep(2)
        click_guide_history_api = self.browser.find_element(*MainPageLocators.guide_history_api)
        click_guide_history_api.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)

    def go_to_guide_statistical_weather_api(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1000)")
        time.sleep(2)
        click_guide_statistical_weather_api = self.browser.find_element(*MainPageLocators.guide_statistical_weather_api)
    ...
    def go_to_guide_weather_map(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1400)")
        time.sleep(2)
        click_guide_weather_map = self.browser.find_element(*MainPageLocators.guide_weather_map)
        click_guide_weather_map.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)

    def go_to_guide_global_precipitation_maps(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1400)")
        time.sleep(2)
        click_guide_global_precipitation_maps = self.browser.find_element(*MainPageLocators.guide_global_precipitation_maps)
        click_guide_global_precipitation_maps.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)
    def go_to_guide_relief_map(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1400)")
        time.sleep(2)
        click_guide_relief_map = self.browser.find_element(*MainPageLocators.guide_relief_map)
    ...
    def go_to_guide_air_quality(self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1600)")
        time.sleep(2)
        click_guide_air_quality = self.browser.find_element(*MainPageLocators.guide_air_quality)
        click_guide_air_quality.click()
        time.sleep(2)
        return LoginPage(browser=self.browser, url=self.browser.current_url)

    def go_to_geocoding_api (self):
        self.browser.maximize_window()
        time.sleep(2)
        self.browser.execute_script("window,scrollTo (0,1650)")
        time.sleep(2)
        click_guide_geocoding_api = self.browser.find_element(*MainPageLocators.guide_geocoding_api)
